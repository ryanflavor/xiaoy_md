...
# 交易所映射
EXCHANGE_SOPT2VT: dict[str, Exchange] = {"SZSE": Exchange.SZSE, "SSE": Exchange.SSE}
...
class SoptMdApi(MdApi):
    ...
    def onRtnDepthMarketData(self, data: dict) -> None:
        ...
        timestamp: str = (
            f"{data['TradingDay']} {data['UpdateTime']}.{int(data['UpdateMillisec']/100)}"
        )
...
class SoptTdApi(TdApi):
    ...
    def connect(
        self, address: str, userid: str, password: str, brokerid: str, auth_code: str, appid: str
    ) -> None:
        """连接服务器"""
        self.userid = userid
        self.password = password
